...
// EXAMPLE HibrnateUtil FYI - FOR REFERENCE
...
public class HibernateUtilEXAMPLE {

    private static final String INTERCEPTOR_CLASS = "hibernate.util.interceptor_class";
    private static Log log = LogFactory.getLog(HibernateUtilEXAMPLE.class);
        ...
        try {
            ...
            if (interceptorName != null) {
                Class<?> interceptorClass =
                        HibernateUtilEXAMPLE.class.getClassLoader().loadClass(interceptorName);
