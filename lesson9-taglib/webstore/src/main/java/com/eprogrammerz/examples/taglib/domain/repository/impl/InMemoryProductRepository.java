package com.eprogrammerz.examples.taglib.domain.repository.impl;
...
public class InMemoryProductRepository implements ProductRepository {
    ...
    public InMemoryProductRepository() {
        ...
        try {
            ...
            iphone.setActiveDate(dateFormat.parse("17/07/2014"));
        ...
        try {
            SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
            laptop_dell.setActiveDate(dateFormat.parse("05/12/2000"));
        } catch (ParseException e) {
        }
        ...
        try {
            SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
            tablet_Nexus.setActiveDate(dateFormat.parse("22/10/2010"));
        } catch (ParseException e) {
        }
